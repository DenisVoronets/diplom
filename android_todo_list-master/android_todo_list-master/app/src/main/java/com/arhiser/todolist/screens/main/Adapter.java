...
public class Adapter extends RecyclerView.Adapter<Adapter.NoteViewHolder> {
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView noteText,prioritetText,tagTex;
        CheckBox completed;
        View delete;
        Note note;
        ...
        public NoteViewHolder(@NonNull final View itemView) {
            ...
            prioritetText = itemView.findViewById(R.id.textView_prioritet);
            tagTex = itemView.findViewById(R.id.textView_tag_fillter);
        ...
        public void bind(Note note) {
            ...
            updateStrokeOut();
            prioritetText.setText(String.valueOf(note.prioritet));
            tagTex.setText(note.tag);
            silentUpdate = true;
