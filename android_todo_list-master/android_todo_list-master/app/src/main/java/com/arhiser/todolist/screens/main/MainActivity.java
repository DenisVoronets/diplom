...
public class MainActivity extends AppCompatActivity {
    ...
    private Button buttonFilter,buttonReturn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                List<Note> noteLiveDataTag = App.getInstance().getNoteDao().getTag(text);
                adapter.setItems(noteLiveDataTag);
        ...
        buttonReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                List<Note> noteLiveData = App.getInstance().getNoteDao().getAll();
                adapter.setItems(noteLiveData);
            }
        });
